...
def main():
    ...
    even_better_draw_circles(rg.Point(100,50),10, 5, 'blue', 5)
    even_better_draw_circles(rg.Point(-200,0),10, 6, 'red', 3)
...
def even_better_draw_circles(point, amount, radii, color, thickness):
